...
function getCoonWords(maxWords) {
    var Words = [
        ...
        "Vegas",
        "200 BMW",
        "Bring it to Saunders",
        "scaryghillies2",
        "Threaten the manager",
        "Build YouTube personality",
        "Is this a sale",
        "#boyswillbeboys",
        "Trying to go to Brazil",
        "Director of Marketing",
        "Another successful marketing meeting",
        "Covid is a fraud",
        "First class",
        "Cease and desist be the move this year",
        "Thinking about selling my Porche",
        "Porsche Upgrade",
        "Joseph",
        "John",
        // "Rat",
